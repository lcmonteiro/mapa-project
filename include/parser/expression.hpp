...
// Integer
// ===============================================
const auto integer_ = forward(
	digits,
	[](auto view, auto value) -> Output<Integer> {
		auto number = Integer();
...
{
	auto parse = [](const auto &symbol, auto &&result) {
